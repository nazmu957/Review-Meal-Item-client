        ...
        <div className=''>
            <form onSubmit={handleReview}>
               ...
               <div className='grid grid-cols-1 lg:grid-cols-2 gap-4'>
                ...
                <input name="photoUrl" type="text" placeholder="Your PhotoUrl" className="input input-bordered input-info w-full " required/>
               ...
               <textarea name="message" className="textarea textarea-info w-full" placeholder="Your Review" required></textarea>
